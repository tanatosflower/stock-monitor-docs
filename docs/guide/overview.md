...
### 2. 「優良株」とは “経済的な堀（Moat）” を持つ企業のこと {#shiso-2}
...
### 3. 「下落の理不尽さ」を自動判別する。ただし立証責任は買い場側にある {#shiso-3}
...
### 4. 出口の思想 — 「安く仕込む」と対になる「テーゼ崩壊時の撤退」 {#shiso-4}
...
### 6. 個人開発として続けられること（低認知負荷・低コスト） {#shiso-6}
...
### 7. 完璧な設計を捨て、実戦データでロジックを締め上げる {#shiso-7}
